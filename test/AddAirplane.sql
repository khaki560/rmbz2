...
exec [dbo].[AddPlane] @name='plane_lodz', @airplaneCoordinates='51.3840722 21.2074830', @airplaneRoute='51.3840722 21.2074830, 51.7197 19.3906'

--- samolot w radomiu ----
DELETE FROM airplanes WHERE [name]='plane_radom';
exec [dbo].[AddPlane] @name='plane_radom', @airplaneCoordinates='51.7197 19.3906', @airplaneRoute='51.3840722 21.2074830, 51.7197 19.3906'
